...
function openComment(line = 1) {
  $("#comment-line").max = app.state.lines.length;
  $("#comment-line").value = Math.max(1, Math.min(line, app.state.lines.length));
  $("#comment-text").value = "";
...
$("#add-comment").addEventListener("click", () => openComment(1));
